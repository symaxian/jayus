...
a.y);case 6:c=Math.abs(a.x-(b.x+b.width/2));d=Math.abs(a.y-(b.y+b.height/2));if(c>b.width/2+a.radius||d>b.height/2+a.radius)return false;c*=2;d*=2;if(c<=b.width||d<=b.height)return true;return(c-b.width)*(c-b.width)+(d-b.height)*(d-b.height)<=4*a.radius*a.radius;case 8:return!(a.x+a.width<b.x||a.y+a.height<b.y||a.x>b.x+b.width||a.y>b.y+b.height);case 9:return b.intersectsAt(a.x,a.y);case 10:return this.intersectsPolygonPolygon(a.toPolygon(),b);case 12:return this.intersectPolygonPolygon(a.toPolygon(),
