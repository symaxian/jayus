...
has:function(a){return 0<=this.items.indexOf(a)},count:function(){return this.items.length},at:function(a){return 0<=a&&a<this.items.length?this.items[a]:null},get:function(a){var b,c;for(b=this.items.length-1;0<=b;b--)if(c=this.items[b],c.id===a)return c;return null},find:function(a){var b,c;for(b=this.items.length-1;0<=b;b--)if(c=this.items[b],c.id===a||c.isParent&&(c=c.find(a),null!==c))return c},add:function(a){if(1===arguments.length)this.items.push(a),this.added(a);else{for(var b=0;b<arguments.length;b++)this.items.push(arguments[b]);
this.addedMany(arguments)}return this},append:function(a){for(var b=0;b<a.length;b++)this.items.push(a[b]);this.addedMany(a);return this},insert:function(a,b){this.items.splice(b,0,a);this.added(a);return this},insertBefore:function(a,b){var c=this.items.indexOf(b);0<c&&(this.items.splice(c-1,0,a),this.added(a));return this},insertAfter:function(a,b){var c=this.items.indexOf(b);-1!==c&&(this.items.splice(c,0,a),this.added(a));return this},remove:function(a){var b,c;if(1===arguments.length)c=this.items.indexOf(a),
0<=c&&(this.items.splice(c,1),this.removed(a));else{for(b=0;b<arguments.length;b++)a=arguments[b],c=this.items.indexOf(a),0<=c&&(this.items.splice(c,1),this.removed(a));this.removedMany(arguments)}return this},removeAt:function(a){if(0<=a&&a<this.items.length){var b=this.items[a];this.items.splice(a,1);this.removed(b)}return this},replace:function(a,b){return this.replaceAt(this.indexOf(a),b)},update:function(a,b){var c=this.indexOf(a);-1===c?this.add(b):this.replaceAt(c,b);return this},replaceAt:function(a,
b){0<=a&&(this.removed(this.items[a]),this.items[a]=b,this.added(b));return this},purge:function(){var a=this.items;this.removedMany(a);this.items=[];this.parent.items===a&&(this.parent.items=this.items);return this},onEach:function(a,b){for(var c=0;c<this.items.length;c++)this.items[c][a].apply(this.items[c],b);return this},forEach:function(a,b){var c,d;for(c=0;c<this.items.length;c++)if(d=a.apply(this.items[c],b),void 0!==d)return d;return null},forEvery:function(a,b){var c,d;for(c=0;c<this.items.length;c++)if(d=
a.apply(this.items[c],b),void 0!==d)return d;return null},sort:function(a){this.items.sort(a);this.parent.listItemsMoved();return this}});jayus.Color=jayus.Dependency.extend({r:0,g:0,b:0,a:1,init:function(){arguments.length&&this.set.apply(this,arguments)},toObject:function(){var a={type:"Color",r:this.r,g:this.g,b:this.b,a:this.a};""!==this.id&&(a.id=this.id);return a},initFromObject:function(a){this.r=a.r;this.g=a.g;this.b=a.b;this.a=a.a;return this.dirty(127)},set:function(a,b,c,d){switch(arguments.length){case 1:return this.set(a,1);case 2:var e=jayus.colors.displayNames.indexOf(a);0>e&&(e=jayus.colors.cssNames.indexOf(a));e+1&&
...
f));d.setBottom(Math.max(d.getBottom(),f+c))}};(function(){jayus.applyObject(jayus.Dependency.prototype,jayus.Responder.prototype);jayus.Entity=jayus.Responder.extend({shapeType:0,isParent:!1,included:!0,visible:!0,alpha:1,isTransformed:!1,actionsToAnimate:0,enableDragEvents:!1,leftDragging:!1,middleDragging:!1,rightDragging:!1,properties:"visible included alpha angle xAnchor yAnchor trackCursor canAcceptCursor canReleaseCursor enableDragEvents".split(" "),animate:function(){this.actionsToAnimate++;return this},init:function(){this.enableDragEvents&&
...
!1,this.fire("rightDragEnd",a)},cursorMove:function(a){var b=!1;this.leftDragging&&(b=this.fire("leftDrag",a)||b);this.middleDragging&&(b=this.fire("middleDrag",a)||b);this.rightDragging&&(b=this.fire("rightDrag",a)||b);return b},cursorOut:function(){this.leftDragging&&this.fire("leftDragEnd");this.middleDragging&&this.fire("middleDragEnd");this.rightDragging&&this.fire("rightDragEnd");this.leftDragging=this.middleDragging=this.rightDragging=!1}})},toObject:function(){var a={type:"Entity"};""!==this.id&&
(a.id=this.id);var b,c,d,e;for(b=0;b<jayus.Entity.prototype.properties.length;b++)c=jayus.Entity.prototype.properties[b],d=this[c],e=typeof d,d!==jayus.Entity.prototype[c]&&("object"===e&&(d=d.toObject()),a[c]=d);return a},initFromObject:function(a){jayus.Dependency.prototype.initFromObject.call(this,a);this.frozen++;var b,c,d,e;for(b=0;b<jayus.Entity.prototype.properties.length;b++)c=jayus.Entity.prototype.properties[b],d=a[c],e=typeof d,void 0!==d&&("object"===e&&(d=jayus.parse(d)),this[c]=d);"string"===
typeof a.tooltip&&this.setTooltip(a.tooltip);"number"===typeof a.xScale&&this.setXScale(a.xScale);"number"===typeof a.yScale&&this.setYScale(a.yScale);"number"===typeof a.scale&&this.setScale(a.scale);"number"===typeof a.xVelocity&&this.setXVelocity(a.xVelocity);"number"===typeof a.yVelocity&&this.setYVelocity(a.yVelocity);"string"===typeof a.dragButton&&this.setDragButton(a.dragButton);"object"===typeof a.parent&&this.setParent(a.parent);"object"===typeof a.constraints&&this.setConstraints(a.constraints);
this.frozen--;return this.dirty(127)},setId:function(a){jayus.Dependency.prototype.setId.call(this,a);jayus.declareChildrenAsProperties&&null!==this.parent&&a&&(this.parent[a]=this)},addHandler:function(a){jayus.Responder.prototype.addHandler.apply(this,arguments);"leftClick"===a?this.addHandler("leftRelease",function(a){jayus.entityPressedOn===this&&this.fire("leftClick",a)}):"middleClick"===a?this.addHandler("middleRelease",function(a){jayus.entityPressedOn===this&&this.fire("middleClick",a)}):
"rightClick"===a?this.addHandler("rightRelease",function(a){jayus.entityPressedOn===this&&this.fire("rightClick",a)}):!this.trackCursor&&(0===a.indexOf("cursor")||0<=a.indexOf("Press")||0<=a.indexOf("Release"))&&(this.trackCursor=!0,null!==this.parent&&this.parent.childCursorTrackingChanged(this,!0))},dirtied:!0,frozen:0,pendingDirty:0,ignoreDirty:0,freeze:function(){this.frozen++;return this},unfreeze:function(){this.frozen--;this.frozen||this.thaw();return this},thaw:function(){jayus.dirtyCount++;
this.fire("dirty",this.pendingDirty);this.dirtied=!0;this.informDependents(this.pendingDirty);null!==this.constraints&&this.constrain();this.pendingDirty=0;return this},dirty:function(a){this.ignoreDirty||(this.frozen?this.pendingDirty|=a:(jayus.dirtyCount++,null!==this.constraints&&this.constrain(),this.isTransformed&&a&10&&(this.matrixDirty=!0),this.fire("dirty",a),this.dirtied=!0,this.informDependents(a),null!==this.parentDisplay&&a&14&&this.parentDisplay.startCursorUpdate()));return this},parent:null,
parentDisplay:null,getAbsoluteParent:function(){return null!==this.parent?this.parent.getAbsoluteParent():this},setParent:function(a){if(this.parent!==a){this.parent=a;this.parentDisplay=a.parentDisplay;this.attach(a);jayus.declareChildrenAsProperties&&this.id&&("undefined"!==typeof a[this.id]?console.error('Entity.setParent() - Collision between child id("'+this.id+'") and parent property('+a[this.id]+")"):a[this.id]=this);this.trackCursor&&a.childCursorTrackingChanged(this,!0);if(this.constraintsNeedParent){this.parentConstrainerOptions=
{};var b=this;this.parent.addHandler("dirty",function(a){b.constrain()},this.parentConstrainerOptions)}this.fire("added")}},removeParent:function(){null!==this.constraints&&this.constraints.needsParent&&(this.parentConstrainerOptions.remove=!0,this.parentConstrainerOptions=null);jayus.declareChildrenAsProperties&&this.id&&delete this.parent[this.id];this.detach(this.parent);this.parent=null;this.underCursor=!1;this.fire("removed")},setIncluded:function(a){this.included!==a&&(this.included=a,this.dirty(127));
return this},include:function(){return this.setIncluded(!0)},exclude:function(){return this.setIncluded(!1)},setVisible:function(a){this.visible!==a&&(this.visible=a,this.dirty(1));return this},show:function(){return this.setVisible(!0)},hide:function(){return this.setVisible(!1)},constraints:null,hasConstraint:null,constraintsNeedParent:!1,parentConstrainerOptions:null,setConstraint:function(a,b){if("object"!==typeof this.constraints){var c={};c[a]=b;this.setConstraints(c)}else this.constraints[a]=
b,this.hasConstraint[a]=!0,this.constrain();return this},clearConstraint:function(a){"object"===typeof this.constraints&&(delete this.constraints[a],this.hasConstraint[a]=!1);return this},setConstraints:function(a){var b,c,d=!1;this.hasConstraint={x:!1,y:!1,width:!1,height:!1};for(b in a)c=a[b],this.hasConstraint[b]=!0,-1!==c.indexOf("parent")&&(d=!0);if(d&&null!==this.parent){var e=this;this.parent.addHandler("dirty",function(){e.constrain()})}this.constraints=a;this.constraintsNeedParent=d;this.constrain();
return this},constrain:function(){if(null!==this.constraints&&(!this.constraintsNeedParent||null!==this.parent)){var a=this.hasConstraint,b=this.constraints;a.x&&this.setX(jayus.executeFormula(this,b.x));a.y&&this.setY(jayus.executeFormula(this,b.y));a.width&&this.setWidth(jayus.executeFormula(this,b.width));a.height&&this.setHeight(jayus.executeFormula(this,b.height))}return this},setAlpha:function(a){if(this.actionsToAnimate)return this.actionsToAnimate--,new jayus.MethodAnimator(this,this.setAlpha,
this.alpha,a);this.alpha!==a&&(this.alpha=a,this.dirty(16));return this},trackCursor:!1,canAcceptCursor:!0,canReleaseCursor:!0,underCursor:!1,hasCursor:!1,cursorX:0,cursorY:0,tooltip:"Hi!",setTooltip:function(a){this.trackCursor=!0;null!==this.parent&&this.parent.childCursorTrackingChanged(this,!0);this.canAcceptCursor=!0;this.tooltip=a},updateCursor:function(a,b){var c=new jayus.Point(a,b);this.isTransformed&&this.getMatrix().inverseTransformPointOnto(a,b,c);this.cursorX=c.x;this.cursorY=c.y;var d=
this.cursorHitTest(c.x,c.y);this.underCursor?d?this.isParent&&this.propagateCursor&&this.updateCursorOnChildren(c.x,c.y):(this.underCursor=!1,this.fire("cursorOut",c),this.isParent&&this.removeCursorFromChildren()):d&&(this.underCursor=!0,this.fire("cursorOver",c),this.isParent&&this.propagateCursor&&this.updateCursorOnChildren(c.x,c.y))},cursorHitTest:function(a,b){return!0},removeCursor:function(){this.underCursor=!1;this.fire("cursorOut",null);this.isParent&&this.removeCursorFromChildren()},dragButton:null,
dragging:!1,dragStarterOptions:null,dragEnderOptions:null,dragHandlerOptions:null,setDragButton:function(a){null===this.dragButton&&"string"===typeof a?(this.dragStarterOptions={},this.dragHandlerOptions={},this.dragEnderOptions={},this.addHandler(a+"Press",function(b){this.dragging=!1;this.dragHandlerOptions.remove=!1;this.dragEnderOptions.remove=!1;var c=this;this.parentDisplay.addHandler("cursorMove",function(a){c.canReleaseCursor=!1;c.dragging||(c.parentDisplay.setCursor("move"),c.fire("dragStart"),
c.dragging=!0);c.fire("dragged",a)||c.translate(a.deltaX,a.deltaY);return!0},this.dragHandlerOptions);jayus.addHandler(a+"Release",function(a,b){c.dragging&&(c.canReleaseCursor=!0,c.parentDisplay.updateCursor(c.parentDisplay.cursor.x,c.parentDisplay.cursor.y),c.fire("dragEnd"),c.parentDisplay.resetCursor());c.dragHandlerOptions.remove=!0;b.remove=!0;if(c.dragging)return c.dragging=!1,!0},this.dragEnderOptions)},this.dragStarterOptions)):"string"===typeof this.dragButton&&null===a?(this.dragStarterOptions.remove=
!0,this.dragStarterOptions=null,this.dragHandlerOptions.remove=!0,this.dragHandlerOptions=null,this.dragEnderOptions.remove=!0,this.dragEnderOptions=null):"string"===typeof this.dragButton&&"string"===typeof a&&this.dragButton!==a&&(this.setDragButton(null),this.setDragButton(a));this.dragButton=a;return this},matrix:null,matrixDirty:!0,getMatrix:function(){this.matrixDirty&&(null===this.matrix?this.matrix=new jayus.Matrix:this.matrix.identity(),this.applyTransforms(this.matrix),this.matrixDirty=
!1);return this.matrix},applyTransforms:function(a){if(this.isTransformed){var b=this.xScale,c=this.yScale;this.flipX&&(b*=-1);this.flipY&&(c*=-1);(this.xAnchor||this.yAnchor)&&a.translate(this.xAnchor,this.yAnchor);a.scale(b,c);a.rotate(this.angle);(this.xAnchor||this.yAnchor)&&a.translate(-this.xAnchor,-this.yAnchor)}return this},angle:0,setAngle:function(a){if(this.actionsToAnimate)return this.actionsToAnimate--,new jayus.MethodAnimator(this,this.setAngle,this.angle,a);this.angle!==a&&(this.angle=
a,this.isTransformed=!0,this.dirty(8));return this},rotate:function(a){return this.setAngle(this.angle+a)},xScale:1,yScale:1,setScale:function(a,b){1===arguments.length&&(b=a);if(this.actionsToAnimate)return this.actionsToAnimate--,new jayus.MethodAnimator(this,this.setScale,[this.xScale,this.yScale],[a,b]);if(this.xScale!==a||this.yScale!==b)this.xScale=a,this.yScale=b,this.isTransformed=!0,this.dirty(8);return this},setScaleAround:function(a,b,c,d){if(3===arguments.length)return this.setScaleAround(a,
a,b,c);var e=this.localToParent(c,d);this.setScale(a,b);var f=this.localToParent(c,d);this.translate(e.x-f.x,e.y-f.y);return this.dirty(127)},scale:function(a,b){1===arguments.length&&(b=a);return this.setScale(this.xScale*a,this.yScale*b)},setXScale:function(a){if(this.actionsToAnimate)return this.actionsToAnimate--,new jayus.MethodAnimator(this,this.setXScale,this.xScale,a);this.xScale!==a&&(this.xScale=a,this.isTransformed=!0,this.dirty(8));return this},setYScale:function(a){if(this.actionsToAnimate)return this.actionsToAnimate--,
new jayus.MethodAnimator(this,this.setYScale,this.yScale,a);this.yScale!==a&&(this.yScale=a,this.isTransformed=!0,this.dirty(8));return this},flipX:!1,flipY:!1,setFlipX:function(a){this.flipX!==a&&(this.flipX=a,this.isTransformed=!0,this.dirty(8));return this},setFlipY:function(a){this.flipX!==a&&(this.flipY=a,this.isTransformed=!0,this.dirty(8));return this},setFlipping:function(a,b){if(this.flipX!==a||this.flipY!==b)this.flipX=a,this.flipY=b,this.isTransformed=!0,this.dirty(8);return this},xAnchor:0,
yAnchor:0,setAnchor:function(a,b){if(1===arguments.length)return this.setAnchor(a.x,a.y);if(this.xAnchor!==a||this.yAnchor!==b)this.xAnchor=a,this.yAnchor=b,this.dirty(8);return this},screenToLocal:function(a,b){if(1===arguments.length)return this.screenToLocal(a.x,a.y);if(null!==this.parent){var c=this.parent.screenToLocal(a,b);return this.parentToLocal(c)}return new jayus.Point(a,b)},parentToLocal:function(a,b){if(1===arguments.length)return this.parentToLocal(a.x,a.y);var c=new jayus.Point(a,b);
this.isTransformed?this.getMatrix().inverseTransformPointOnto(a,b,c):(c.x-=this.x,c.y-=this.y);return c},localToScreen:function(a,b){return 1===arguments.length?this.localToScreen(a.x,a.y):null!==this.parent?this.parent.localToScreen(this.localToParent(a,b)):new jayus.Point(a,b)},localToScreenOnto:function(a,b,c){null!==this.parent?(this.localToParentOnto(a,b,c),this.parent.localToScreenOnto(c.x,c.y,c)):(c.x=a,c.y=b);return c},localToParent:function(a,b){return 1===arguments.length?this.localToParent(a.x,
a.y):this.localToParentOnto(a,b,new jayus.Point)},localToParentOnto:function(a,b,c){if(this.isTransformed)return this.getMatrix().transformPointOnto(a,b,c);c.x=a+this.x;c.y=b+this.y;return c},running:!1,xVelocity:0,yVelocity:0,setXVelocity:function(a){this.xVelocity=a;this.running||(jayus.animators.push(this),this.running=!0);return this},setYVelocity:function(a){this.yVelocity=a;this.running||(jayus.animators.push(this),this.running=!0);return this},setVelocity:function(a,b){if(1===arguments.length)return this.setVelocity(a.x,
a.y);this.xVelocity=a;this.yVelocity=b;this.running||(jayus.animators.push(this),this.running=!0);return this},clearVelocity:function(){this.running&&(this.yVelocity=this.xVelocity=0,jayus.animators.splice(jayus.animators.indexOf(this),1),this.running=!1);return this},tick:function(a,b){this.translate(this.xVelocity*b,this.yVelocity*b)},intersects:function(a){return jayus.intersectTest(this,a)},intersectCount:function(a){var b,c=0;for(b=a.length-1;0<=b;b--)jayus.intersectTest(this,a[b])&&c++;return c},
intersectsAny:function(a){a instanceof jayus.List&&(a=a.items);for(var b=0;b<a.length;b++)if(jayus.intersectTest(this,a[b]))return!0;return!1},intersectsAll:function(a){a instanceof jayus.List&&(a=a.items);for(var b=0;b<a.length;b++)if(!jayus.intersectTest(this,a[b]))return!1;return!0},intersectsWhich:function(a){a instanceof jayus.List&&(a=a.items);var b,c=[];for(b=0;b<a.length;b++)jayus.intersectTest(this,a[b])&&c.push(a[b]);return c},rasterize:function(){var a=this.getScope(),a=new jayus.Surface(a.width,
a.height),b=this.x,c=this.y;this.y=this.x=0;this.drawOnto(a);this.x=b;this.y=c;return a},drawOnto:function(a){var b=a.context;b.save();this.drawOntoContext(b,0,0);b.restore();a.dirty(16);return this}})})();jayus.RectEntity=jayus.Entity.extend({shapeType:4,properties:"x y width height roundX roundY alignBg".split(" "),updateCursor:function(a,b){var c=new jayus.Point(a,b);this.isTransformed?this.getMatrix().inverseTransformPointOnto(a,b,c):(c.x-=this.x,c.y-=this.y);this.cursorX=c.x;this.cursorY=c.y;var d=this.cursorHitTest(c.x,c.y);this.underCursor?d?this.isParent&&this.propagateCursor&&this.updateCursorOnChildren(c.x,c.y):(this.underCursor=!1,this.fire("cursorOut",c),this.isParent&&this.removeCursorFromChildren()):
...
d);null!==this.bg&&(a.bg=this.bg.toObject());null!==this.bounds&&(a.bounds=this.bounds.toObject());return a},initFromObject:function(a){jayus.Entity.prototype.initFromObject.call(this,a);this.ignoreDirty++;var b,c,d;for(b=0;b<jayus.RectEntity.prototype.properties.length;b++)c=jayus.RectEntity.prototype.properties[b],d=a[c],"undefined"!==typeof d&&(this[c]=d);"object"===typeof a.bounds&&(this.bounds=jayus.parse(a.bounds));"boolean"===typeof a.negateBlur&&(this.negateBlur=a.negateBlur);"boolean"===
typeof a.buffering&&this.setBuffering(a.buffering);"object"===typeof a.bg&&this.setBg(a.bg);"object"===typeof a.widthPolicy&&(this.widthPolicy=jayus.parse(a.widthPolicy));"object"===typeof a.heightPolicy&&(this.heightPolicy=jayus.parse(a.heightPolicy));this.ignoreDirty--;return this.dirty(127)},x:0,y:0,setX:function(a){if(this.actionsToAnimate)return this.actionsToAnimate--,new jayus.MethodAnimator(this,this.setX,this.x,a);this.x!==a&&(this.x=a,this.dirty(2));return this},setY:function(a){if(this.actionsToAnimate)return this.actionsToAnimate--,
...
setBottom:jayus.Rectangle.prototype.setBottom,getPosAt:function(a,b){return 1===arguments.length?this.getPosAt(a.x,a.y):this.localToParent(a*this.width,b*this.height)},setPosAt:function(a,b,c,d){return 3===arguments.length?this.setPosAt(a.x,a.y,b,c):this.translate(a-(this.x+c*this.width),b-(this.y+d*this.height))},setRelativeAnchor:function(a,b){return 1===arguments.length?this.setAnchor(this.width*a.x,this.height*a.y):this.setAnchor(this.width*a,this.height*b)},roundX:!1,roundY:!1,setRounding:function(a,
b){if(1===arguments.length)this.roundX=a,this.roundY=b;else if(this.roundX!==a||this.roundY!==b)this.roundX=a,this.roundY=b,this.dirty(127);return this},body:null,setBody:function(a){null!==this.body?delete this.body.entity:(jayus.box2d.physicalEntities.push(this),this.setAnchor(this.width/2,this.height/2));this.body=a;this.body.entity=this;return this},removeBody:function(){null!==this.body&&(delete this.body.entity,this.body=null,jayus.box2d.physicalEntities.splice(jayus.box2d.physicalEntities.indexOf(this),
1));return this},updateFromBody:function(){if(null!==this.body&&this.body.IsAwake()){var a=this.body.GetPosition();this.setPosAt(a.x,a.y,0.5,0.5);this.angle=this.body.GetAngle();this.matrixDirty=this.isTransformed=!0}},width:0,height:0,setWidth:function(a){if(this.actionsToAnimate)return this.actionsToAnimate--,new jayus.MethodAnimator(this,this.setWidth,this.width,a);a!==this.width&&this.changeSize(a,this.height);return this},setHeight:function(a){if(this.actionsToAnimate)return this.actionsToAnimate--,
new jayus.MethodAnimator(this,this.setHeight,this.height,a);a!==this.height&&this.changeSize(this.width,a);return this},setSize:function(a,b){if(1===arguments.length)return this.setSize(a.width,a.height);this.width===a&&this.height===b||this.changeSize(a,b);return this},changeSize:function(a,b){this.width=a;this.height=b;this.dirty(4)},intersectsAt:function(a,b){return this.getBounds().intersectsAt(a,b)},getUnFrame:function(){return new jayus.Rectangle(this.x,this.y,this.width,this.height)},getFrame:function(){return this.isTransformed?
(new jayus.Polygon.Rectangle(0,0,this.width,this.height)).transform(this.getMatrix()):new jayus.Rectangle(this.x,this.y,this.width,this.height)},getScope:function(){return this.getFrame().getScope()},bounds:null,boundsClone:null,getBounds:function(){return null!==this.bounds?(this.bounds.cloneOnto(this.boundsClone),this.boundsClone.translate(this.x,this.y)):this.getFrame().getScope()},setBounds:function(a){"number"!==a.shapeType&&(a=jayus.parse(a));null!==this.bounds&&this.bounds.detach(this);this.bounds=
a;this.bounds.attach(this);this.boundsClone=this.bounds.clone();this.shapeType=0;return this},clearBounds:function(){null!==this.bounds&&(this.bounds.detach(this),this.boundsClone=this.bounds=null,this.shapeType=4);return this},componentDirtied:function(a,b){a===this.bounds&&this.bounds.cloneOnto(this.boundsClone)},bg:null,alignBg:!0,setBg:function(a){a instanceof jayus.Brush||(a=new jayus.Brush(a));null!==this.bg&&this.bg.detach(this);this.bg=a;this.bg.attach(this);return this.dirty(16)},clearBg:function(){null!==
this.bg&&(this.bg.detach(this),this.bg=null,this.dirty(16));return this},buffered:!1,bufferBg:!0,canvas:null,context:null,negateBlur:!1,setBuffering:function(a){!this.buffered&&a?(this.canvas=document.createElement("canvas"),this.context=this.canvas.getContext("2d"),this.refreshBuffer()):this.buffered&&!a&&(this.context=this.canvas=null);this.buffered=a;return this},refreshBuffer:function(){if(this.buffered){var a=this.canvas;if(this.width!==a.width||this.height!==a.height)a.width=this.width,a.height=
this.height;this.fullyRefreshBuffer()}},fullyRefreshBuffer:function(){if(this.buffered){var a=this.context;a.clearRect(0,0,this.width,this.height);a.save();this.bufferBg&&null!==this.bg&&this.bg.paintRect(a,0,0,this.width,this.height);this.paintContents(a);a.restore()}},applyTransforms:function(a){var b=this.x,c=this.y;this.roundX&&(b=Math.round(b));this.roundY&&(c=Math.round(c));if(this.isTransformed){var d=this.xScale,e=this.yScale;if(this.xAnchor||this.yAnchor)b+=this.xAnchor,c+=this.yAnchor;a.translate(b,
c);a.scale(d,e);a.rotate(this.angle);(this.xAnchor||this.yAnchor)&&a.translate(-this.xAnchor,-this.yAnchor);if(this.flipX||this.flipY)a.translate(this.width/2,this.height/2),a.scale(this.flipX?-1:1,this.flipY?-1:1),a.translate(-this.width/2,-this.height/2)}else(b||c)&&a.translate(b,c);return this},drawOntoContext:function(a){a.save();1!==this.alpha&&(a.globalAlpha*=this.alpha);this.applyTransforms(a);this.buffered?(this.dirtied&&this.refreshBuffer(),this.bufferBg||null===this.bg||(this.alignBg&&this.bg.lineWidth%
2?this.bg.paintRect(a,0.5,0.5,Math.round(this.width),Math.round(this.height)):this.bg.paintRect(a,0,0,this.width,this.height)),this.negateBlur?jayus.manuallyDrawImage(this.context,a,this.width,this.height):a.drawImage(this.canvas,0,0)):(null!==this.bg&&(this.alignBg&&this.bg.lineWidth%2?this.bg.paintRect(a,0.5,0.5,Math.round(this.width),Math.round(this.height)):this.bg.paintRect(a,0,0,this.width,this.height)),this.paintContents(a));this.dirtied=!1;a.restore();return this}});jayus.PaintedShape=jayus.Entity.extend({shape:null,brush:null,init:function(a,b){jayus.Entity.prototype.init.apply(this);2===arguments.length&&(this.shape=a,a.attach(this),void 0!==b&&this.setBrush(b))},toObject:function(){var a=jayus.Entity.prototype.toObject.apply(this);a.type="PaintedShape";null!==this.shape&&(a.shape=this.shape.toObject());null!==this.brush&&(a.brush=this.brush.toObject());return a},initFromObject:function(a){jayus.Entity.prototype.initFromObject.call(this,a);this.ignoreDirty++;
...
a&&(null!==this.shape&&this.shape.detach(this),this.shape=a,a.attach(this),this.dirty(127));return this},setBrush:function(a){null!==this.brush&&this.brush.detach(this);a instanceof jayus.Brush||(a=new jayus.Brush(a));this.brush=a;a.attach(this);return this.dirty(16)},clearBrush:function(){null!==this.brush&&(this.brush.detach(this),this.brush=null,this.dirty(16));return this},getScope:function(){if(!this.isTransformed)return this.shape.getScope();var a=this.shape.getScope().getTransformed(this.getMatrix()).getScope();
if(this.brush.stroking||this.brush.shadowing){var b=Math.max(this.xScale,this.yScale),c=0,d=0,e=0,f=0;this.brush.stroking&&(c=10,"number"===typeof this.brush.miterLimit&&(c=this.brush.miterLimit),c=d=e=f=c*b/1.5);this.brush.shadowing&&(c=Math.max(c,c+this.brush.shadowBlur-this.brush.shadowOffsetX),d=Math.max(d,d+this.brush.shadowBlur+this.brush.shadowOffsetX),e=Math.max(e,e+this.brush.shadowBlur-this.brush.shadowOffsetY),f=Math.max(f,f+this.brush.shadowBlur+this.brush.shadowOffsetY));a.setSize(a.width+
